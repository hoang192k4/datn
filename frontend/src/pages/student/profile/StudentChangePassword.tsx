    ...
    const handleChangePassword = async (data: FormPassword) => {
        try {
            if (data.new_password !== data.new_password_confirmation) {
                ...
                const res = await studentChangePassword(data.current_password, data.new_password, data.new_password_confirmation)
...
export default StudentChangePasswrod;